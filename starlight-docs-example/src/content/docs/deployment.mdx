...
<Tabs>
  ...
  <TabItem label="Netlify">
    Set environment variables in Netlify under **Site settings > Environment variables**.
  ...
  <TabItem label="GitHub Pages">
    Set environment variables in your GitHub Actions workflow file using `env`:
